...
class BorrowerOperationsProxy extends Proxy {
  ...
  async withdrawBUSDC(...params) {
    return this.forwardFunction(params, 'withdrawBUSDC(uint256,uint256,address,address)')
  }

  async repayBUSDC(...params) {
    return this.forwardFunction(params, 'repayBUSDC(uint256,address,address)')
  }
  ...
  async BUSDC_GAS_COMPENSATION(...params) {
    return this.proxyFunction('BUSDC_GAS_COMPENSATION', params)
  }
...
class TroveManagerProxy extends Proxy {
  ...
  async getPendingBUSDCDebtReward(...params) {
    return this.proxyFunction('getPendingBUSDCDebtReward', params)
  }
  ...
  async L_BUSDCDebt() {
    return this.proxyFunction('L_BUSDCDebt', [])
  }
...
class StabilityPoolProxy extends Proxy {
  ...
  async getCompoundedBUSDCDeposit(user) {
    return this.proxyFunctionWithUser('getCompoundedBUSDCDeposit', user)
  }
...
class B2BStakingProxy extends Proxy {
  constructor(owner, proxies, tokenScriptAddress, token) {
    super(owner, proxies, tokenScriptAddress, token)
  }
  ...
  async F_BUSDC(user) {
    return this.proxyFunctionWithUser('F_BUSDC', user)
  }
}
