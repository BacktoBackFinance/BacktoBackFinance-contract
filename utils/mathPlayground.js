...
const ABDKOperations = async () => {
    ...
    // Example computaton: BUSDC -> Ether price conversion

    // price = 200.12345678, stored as uint
    // convert 6123456700909.123456789123456789 BUSDC to Ether
    // amount = 6123456700909.123456789123456789 BUSDC / 200.12345678
    ...
    */
    ...
    /* TODO: will L_ETH, L_BUSDC overflow if stored as 64.64? Possibly need to store as uint, divide by 1e18, then use
    the resulting 64.64  */
